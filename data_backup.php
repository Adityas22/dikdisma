...
<body>
   ...
   <div class="data">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="export.php" class="btn btn-secondary">halaman export</a>
            </div>
        ...
        <div class="table-responsive mt-4 data-tables datatable-dark"">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class='btn btn-info detailButton' data-id='<?= $row["id"] ?>' data-toggle='modal'
                            data-target='#detailModal'>Detail</button>
                        <!-- <a href='#detaikModal?id=<?= $row["id"] ?>' class='btn btn-info'>Detail</a> -->
                    </td>
                </tr>
                <?php
                        $no++; // Tambahkan nomor
